...
<head>
    ...
    <title>namalunek | Create post</title>
...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="photos/logo2.png" alt="logo" width="166" height="73">
        </a>
...
<div class="d-flex justify-content-center">
    <div class="card w-75 p-3">
        <div class="card-header text-center">
            <div class="card-title"> <h3>Create a post</h3> </div>
        </div>
        @if ($errors->any())
        ...
        <div class="card-body">
            <!-- form start -->
            <form role="form"  action="{{ route('storepost') }}" id="post-form"
                ...
                <div>
                    <div class="form-group{{ $errors->has('post_content')?'has-error':'' }}" id="roles_box">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" name="photo" id="photo" placeholder="https://website.com/photos/myphoto.jpg" required>
                        </div>
                        <div class="mb-3">
                            <label for="summary" class="form-label font-weight-bold">Summary</label>
                            <textarea class="form-control" name="summary" id="summary" cols="20" rows="3" required maxlength="150"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="post_content" class="form-label font-weight-bold">Content</label>
                            <textarea class="form-control" name="post_content" id="post_content" cols="20" rows="5" required minlength="10" maxlength="1000"></textarea>
                        </div>
                    </div>
                </div>
